...
function theme_get_params($url) {
    ...
    unset($get_params['preview']);
    unset($get_params['preview_iframe']);
    unset($get_params['template']);
    unset($get_params['stylesheet']);
    unset($get_params['page']);
    unset($get_params['TB_iframe']);
...
function theme_is_current_url($url) {
    ...
    return $get_params == $current_get_params && $parsed_url['path'] == $parsed_current_url['path'];
}
