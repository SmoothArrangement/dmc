...
function theme_set_slider_wrapper($widget_id, $one_row) {
    ...
    $slider_wrapper[$widget_id] = array(
        'before' => '<div class=" bd-grid-41"><div class="container-fluid"><div class="separated-grid row"><div class="carousel slide" data-slider-id="'.$widget_id.'" '.($one_row ? 'style="padding-left: 0; padding-right: 0; width: 100%"' : '').'>',
...
?>
 ...
 false, ' bd-container-8 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-imagestyles bd-custom-table',
            '<div class=" bd-pricetext-5">', '</div>',
            
 false, ' bd-container-7 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-imagestyles bd-custom-table');
?></span>
<?php
        }
?>
