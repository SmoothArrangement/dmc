...
function theme_set_slider_wrapper($widget_id, $one_row) {
    ...
    $slider_wrapper[$widget_id] = array(
        'before' => '<div class="data-control-id-771689 bd-grid-41"><div class="container-fluid"><div class="separated-grid row"><div class="carousel slide" data-slider-id="'.$widget_id.'" '.($one_row ? 'style="padding-left: 0; padding-right: 0; width: 100%"' : '').'>',
...
?>
 ...
 false, 'data-control-id-275 bd-container-8 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-imagestyles bd-custom-table',
            '<div class="data-control-id-242 bd-pricetext-5">', '</div>',
            
 false, 'data-control-id-241 bd-container-7 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-imagestyles bd-custom-table');
?></span>
<?php
        }
?>
