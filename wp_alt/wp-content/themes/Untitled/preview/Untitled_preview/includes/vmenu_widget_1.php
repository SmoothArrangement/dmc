...
function theme_vmenu_submenu_start_1_24($class = '') {
    ...
    <ul class="data-control-id-127708 bd-menu-24 nav nav-pills <?php echo $class; ?>"><?php
    return ob_get_clean();
}
...
class VMenuWidget extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        echo '<div class="data-control-id-3499 bd-container-2 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-imagestyles bd-custom-table shape-only">';
