...
?>
 ...
 $theme_hide_sidebar_area ||
            ...
            <div class="bd-sidebararea-6-column data-control-id-1153337 bd-flex-vertical bd-flex-fixed<?php if ($hide) echo ' hidden bd-hidden-sidebar'; ?>">
        ...
        <?php else: ?>
            <?php if ($area_content
 && !$theme_hide_sidebar_area): ?>
                <div class="bd-sidebararea-6-column data-control-id-1153337 bd-flex-vertical bd-flex-fixed">
                    <div class="bd-sidebararea-6 bd-flex-wide">
                        <?php echo $area_content ?>
                    </div>
                </div>
