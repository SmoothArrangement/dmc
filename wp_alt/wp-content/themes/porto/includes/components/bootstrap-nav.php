...
class Bootstrapwp_Walker_Nav_Menu extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if( 'phone' == $item->title ) {
            ...
            $output .= $indent .  '<li class="phone"><span><i class="fa fa-phone"></i>' . get_setting( 'topbar_ph' ) . '</span></li>';
        }
        elseif( is_str_contain( 'divider', $item->title ) ) {
            ...
            $item_output = $args->before;
                $item_output .= '<a' . $attributes . '>';
                    ...
                    if( $args->has_children && $depth == 0 ) $item_output .= ' <i class="fa fa-angle-down"></i>';
